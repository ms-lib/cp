...
**Tone:** Encouraging, active, motivational  
...
**Text:**
- Title: Making the Most of Your School Year
...
**Fase:** OPENING  
**Tipe Halaman:** Opener  
**Judul Halaman:** Welcome to Your School Guide  
**Jumlah Kolom:** 1  
...
**Judul Halaman:** Three Easy Habits  
**Jumlah Kolom:** 3  

| Kolom 1 | Kolom 2 | Kolom 3 |
|---------|---------|---------|
| **Sleep Routine:**<br>Adjusting our sleeping hours early helps us stay energetic. | **Active Mind:**<br>Reading fifteen minutes daily keeps our minds curious. | **Supply Prep:**<br>Organizing our schoolbags and tools makes routines simple. |

**Visual Note:** Three clean columns in bright primary colors with bold circular icons for a moon, a book, and a backpack.  
...
**Fase:** CORE CONTENT  
**Tipe Halaman:** List/Value  
**Judul Halaman:** Daily School Habits  
**Jumlah Kolom:** 2  

| Kolom 1 | Kolom 2 |
|---------|---------|
| **Morning Routine:**<br>Preparing clothes the night before and arriving at homeroom with positive energy starts our day strong. | **Recess Fun:**<br>Saying hello to new classmates and keeping our desk areas clean makes recess fun for everyone. |
...
**Fase:** CORE CONTENT  
**Tipe Halaman:** List/Value  
**Judul Halaman:** School Life Checklist  
**Jumlah Kolom:** 4  

| Kolom 1 | Kolom 2 | Kolom 3 | Kolom 4 |
|---------|---------|---------|---------|
| **Notebooks:**<br>Ruled study binder. | **Pens:**<br>Labeled colored pens. | **Portal:**<br>Online login codes. | **Goal Card:**<br>Main goal target. |
...
**Judul Halaman:** Weekly Buddy Game  
**Jumlah Kolom:** 2  

| Kolom 1 | Kolom 2 |
|---------|---------|
| **Choose Buddy:**<br>Sharing one daily habit target with our desk partner helps us practice. | **Checklist Win:**<br>Checking off completed checklist steps on our cards together is fun. |
...
| Kolom 1 | Kolom 2 | Kolom 3 |
|---------|---------|---------|
| **Principal Guide:**<br>Adeline Palmerston oversees student resources and schedules. | **Activity Lead:**<br>Lorna Alvarado helps coordinate clubs and school events. | **Tech Assistant:**<br>Chiaki Sato assists with family portal password accounts. |

**Visual Note:** Split layout using soft orange and yellow panels, dividing final actions into three neat columns.  
...
### Design Philosophy:
- **Tone:** Encouraging, active, and motivational.
