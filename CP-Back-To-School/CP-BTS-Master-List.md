# CP-Back-To-School — Master Title List

**Theme:** Back To School  
**Total Cluster:** 6 utama + 1 bonus (A–G)  
**Total Files:** 43 judul  
**Peak Season:** Juli–Agustus (mulai produksi: Mei–Juni)
...
| # | Judul | Angle |
|---|---|---|
| A-01 | Back To School Night Presentation | Evening event untuk ortu |
| A-02 | First Day Of School Welcome Presentation | Hari pertama, guru ke murid |
| A-03 | School Orientation Program And Agenda | Murid baru, jadwal orientasi |
| A-04 | Back To School Open House Event Guide | Ortu kunjungi sekolah |
| A-05 | Welcome Back To School Ceremony Presentation | Upacara/seremoni sambutan |
| A-06 | New School Year Kickoff Event Program | Kick-off event, multi-audience |
| A-07 | Back To School Staff And Team Orientation | Orientasi internal guru/staf |

---

## B — Teacher Introduction & Classroom
...
| # | Judul | Angle |
|---|---|---|
| B-01 | Meet The Teacher Back To School Presentation | Intro guru ke murid |
| B-02 | Welcome To My Classroom Presentation | Setup dan vibe kelas |
| B-03 | Our Classroom Rules And Expectations Guide | Aturan & ekspektasi kelas |
| B-04 | About Your Teacher This School Year | Versi personal/intimate |
| B-05 | How Our Classroom Works This Year | Operasional kelas, praktis |
| B-06 | Our Class Goals And Plans For The Year | Goals kelas bersama |
| B-07 | A Guide To Our Classroom Community | Community angle, inklusif |

---

## C — Student Introduction & Profile
...
| # | Judul | Angle |
|---|---|---|
| C-01 | All About Me Back To School Presentation | Murid kenalkan diri sendiri |
| C-02 | Meet The Class Student Introduction Slides | Guru kenalkan seluruh kelas |
| C-03 | New Student Welcome Back To School Guide | Menyambut murid baru |
| C-04 | Getting To Know Your Classmates Presentation | Ice breaker, group activity |
| C-05 | My Goals And Hopes For This School Year | Future-oriented, personal |
| C-06 | About Me First Day Of School Slides | Simple, anak-anak friendly |

---

## D — Parent & Family Engagement
...
## F — Activities, Schedule & School Life
...
| # | Judul | Angle |
|---|---|---|
| F-01 | School Club Introduction And Overview | Presentasi klub ke calon anggota |
| F-02 | Extracurricular Activities Guide For Students | Overview semua ekskul |
...
## G — Business & Back To School Marketing (Bonus)
...
| Cluster | Nama | Jumlah Judul | Audience |
|---|---|---|---|
| A | Event & Orientation | 7 | Admin, guru |
| B | Teacher Introduction & Classroom | 7 | Guru |
| C | Student Introduction & Profile | 6 | Murid, guru |
| D | Parent & Family Engagement | 6 | Guru, admin ke ortu |
| E | Goals, Motivation & New Year | 6 | Murid, guru |
| F | Activities, Schedule & School Life | 6 | Klub, OSIS, guru |
| G | Business & Marketing (bonus) | 5 | Brand, retailer |
| **Total** | | **43 judul** | |
...
```
BATCH 1 — demand tertinggi, timing paling kritis
→ Cluster B: Teacher Introduction  
→ Cluster A: Event & Orientation

BATCH 2 — demand solid
→ Cluster C: Student Introduction  
→ Cluster D: Parent Engagement

BATCH 3 — evergreen + long tail
→ Cluster E: Goals & Motivation  
→ Cluster F: Activities & Schedule

BATCH 4 — scale ke B2B (opsional)
→ Cluster G: Business & Marketing
```
