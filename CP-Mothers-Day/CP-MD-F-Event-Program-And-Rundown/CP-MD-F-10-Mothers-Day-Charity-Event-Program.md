# JUDUL 10 OF 15
## Mothers Day Charity Event Program Presentation
...
### PAGE 1 - COVER
**Layout:** Cover page  
**Visual Note:** High-impact purposeful design using clean minimalist typography. Deep slate background with sage green accents and a minimalist gold line-art of a helping hand and a heart-shaped blossom. Use Title Case for the title.
...
**Visual Note:** Infographic markers set against a sage background for quick charity scanning.
...
| Kolom 1 | Kolom 2 |
|---------|---------|
| **The Auction:**<br>Curated artisanal packages and neighborhood crafts for an unshakeable support fund at Studio Shodwe. | **The Impact:**<br>Presenting the unshakeable financial roadmap for the Liceria & Co. Maternal Care Initiative. |

**Visual Note:** Giving-spotlight using a sophisticated academic design and high-end serif. Use "In-Use" text.
...
| Kolom 1 |
|---------|
| Adeline Palmerston, our lead director at Studio Shodwe, emphasizes that every unshakeable charity event is built on invisible details. At Liceria & Co. Academy, we believe that an unhurried atmosphere is the highest gift for any generous donor. Your rundown should provide an unshakeable container where families feel empowered to connect, share stories, and celebrate the unshakeable maternal impact on our community healthcare. |
...
**Text:**
- Charity Event Program
- Studio Shodwe Charity Force • 2024
