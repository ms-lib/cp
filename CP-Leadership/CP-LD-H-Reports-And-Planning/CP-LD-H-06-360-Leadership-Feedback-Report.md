...
### PAGE 2 - OPENER
**Fase:** Opening  **Tipe Halaman:** Opener  **Judul Halaman:** 360 Leadership Feedback Report  **Jumlah Kolom:** 1  
| Kolom 1 |
|---------|
...
### PAGE 3 - CONTEXT
**Fase:** Context  **Tipe Halaman:** Context  **Judul Halaman:** Two Lenses of 360 Feedback  **Jumlah Kolom:** 2  
| Kolom 1 | Kolom 2 |
|---------|---------|
...
### PAGE 4 - CORE A
**Fase:** Core Content  **Tipe Halaman:** Core A  **Judul Halaman:** How to Read This Report  **Jumlah Kolom:** 1  
| Kolom 1 |
|---------|
...
### PAGE 5 - CORE B
**Fase:** Core Content  **Tipe Halaman:** Core B  **Judul Halaman:** Four Feedback Dimensions  **Jumlah Kolom:** 4  
...
### PAGE 6 - CORE C
**Fase:** Core Content  **Tipe Halaman:** Core C  **Judul Halaman:** Facilitator Perspectives  **Jumlah Kolom:** 3  
...
### PAGE 7 - ENGAGEMENT
**Fase:** Engagement  **Tipe Halaman:** Engagement  **Judul Halaman:** What Participants Experienced  **Jumlah Kolom:** 2  
| Kolom 1 | Kolom 2 |
|---------|---------|
...
**Fase:** Emotional Peak  **Tipe Halaman:** Emotional / Reflective  **Judul Halaman:** Feedback Is a Form of Trust  **Jumlah Kolom:** 1  
| Kolom 1 |
|---------|
...
### PAGE 9 - CLOSING
**Fase:** Closing  **Tipe Halaman:** Closing  **Judul Halaman:** From Feedback to Action  **Jumlah Kolom:** 2  
| Kolom 1 | Kolom 2 |
|---------|---------|
...
- Pages 1 and 10: full-bleed deep slate background, gold headline, ivory body text
- Page 2 (Opener): report-document style — label fields clearly stacked, body paragraph below; formal but warm
- Page 3 (2 columns): equal-width split, gold column headings, light slate divider; clean and balanced
- Page 5 (4 columns): text-forward feedback dimension cards — label bold in gold, description in body font
- Page 6 (3 columns): portrait photo placeholder per column, italic quote, name + role below in small type
- Page 7 (2 cards): horizontal cards, name above a gold rule, role small, quote body below
- Page 8 (Emotional Peak): large centered layout, gold accent bar or underline on section title
- Page 9 (2 columns): action-step layout — headings bold, body descriptive and warm
- Deep slate / gold / ivory / white palette: authoritative, warm, and respectful of the developmental intent
- Font suggestion: bold serif headline for gravitas, clean sans-serif body for readability
