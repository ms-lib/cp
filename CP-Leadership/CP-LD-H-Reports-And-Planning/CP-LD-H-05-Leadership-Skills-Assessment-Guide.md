# Navy Leadership Skills Assessment Guide Modern — JUDUL 5 OF 9
## Leadership Skills Assessment Guide

**Sub-Topic:** H - Reports & Planning (Assessment)
**Main Keywords:** leadership skills, skills assessment, leadership skills assessment guide, evaluating leadership capabilities, leadership competency review, leader skills evaluation presentation, skills-based leadership assessment
**Audience:** Leaders, managers, coaches, HR
**Style:** Modern, Clean, Bold, Professional
**Tone:** Honest, practical, growth-focused
...
### PAGE 1 - COVER
**Layout:** Cover page
**Visual Note:** Full-bleed navy background, teal headline, ivory supporting text.
...
**Visual Note:** Equal-width layout, teal column headings, light navy divider line between columns.
...
**Visual Note:** Single-column body text, centered or left-aligned; clean and readable.
...
**Visual Note:** Text-forward skill cards — label bold in teal, description in body font; consistent card heights.
...
**Visual Note:** Portrait placeholder per column, italic quote, name + role in small sans-serif.
...
**Visual Note:** Horizontal card layout, name above a teal rule, quote body below; clean and airy.
...
**Visual Note:** Large centered type, teal accent bar or line; warm and motivating feel.
...
**Visual Note:** Action-oriented layout, headings in navy/teal, body text in clean readable size.

---

### PAGE 10 - BACK COVER
**Layout:** Back cover page
**Visual Note:** Full-bleed navy background, teal tagline, ivory body text. Matches Page 1 palette.

**Text:**
- Tagline: Understand Your Skills. Build Your Leadership.
- Organization: Liceria & Co.
- Contact Line: Prepared by the L&D and Leadership Development Team
- Closing Note: Strong leadership is built one skill at a time. Thank you for taking this step.

---

## NOTES FOR DESIGNER

- Pages 1 and 10: full-bleed navy background, teal headline, ivory supporting text
- Page 2 (Opener): clean guide/report format — label fields left-aligned, body paragraph below; structured and readable
- Page 3 (2 columns): equal-width layout, teal column headings, light navy divider line between columns
- Page 5 (4 columns): text-forward skill cards — label bold in teal, description in body font; consistent card heights
- Page 6 (3 columns): portrait placeholder per column, italic quote, name + role in small sans-serif
- Page 7 (2 cards): horizontal card layout, name above a teal rule, quote body below; clean and airy
- Page 8 (Emotional Peak): large centered type, teal accent bar or line; warm and motivating feel
- Page 9 (2 columns): action-oriented layout, headings in navy/teal, body text in clean readable size
- Navy / teal / ivory / white palette: confident, clear, practical — appropriate for a professional guide
- Font pairing: bold sans-serif headline, clean sans body for readability
