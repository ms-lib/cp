# JUDUL 2 OF 9
## Public Speaking For Leaders Guide

**Sub-Topic:** E - Skills & Competency (Communication)
**Main Keywords:** public speaking, leadership presence, public speaking for leaders, leadership speaking skills, how leaders speak in public, public speaking confidence, leadership presentation skills, speaking skills for managers
**Audience:** Leaders, managers, anyone who presents or speaks at work
**Style:** Modern, Clean, Bold, Professional
**Tone:** Encouraging, practical, energizing
...
### PAGE 1 - COVER
**Layout:** Cover page
**Visual Note:** Slate and amber palette with clean ivory and white. Bold, energizing typography. Use a subtle stage or spotlight motif to suggest visibility, presence, and confident speaking.

**Text:**
- Title: Public Speaking For Leaders
- Subtitle: A Practical Guide for Everyone Who Leads and Speaks at Liceria & Co.
...
**Visual Note:** Three bold element cards in amber and slate. Icon per element. Strong typographic hierarchy.
...
**Visual Note:** Reflective full-width layout with bold serif quote-style typography and an amber horizontal accent rule.
...
**Visual Note:** Four numbered principle cards in a horizontal flow. Bold amber numbers, slate card backgrounds, ivory text. Clean and modern.
...
**Visual Note:** Dual-profile spotlight with bold slate cards and amber accent. Use "In-Use" text.
...
**Visual Note:** Three testimonial cards in a bold modern layout. Short-form names only. Use "In-Use" text.
...
**Visual Note:** High-impact motivational layout with bold amber typography and strong slate background. Ample white space.
...
**Visual Note:** Split closing layout — left for motivating send-off, right for clear next steps. Slate and amber finish.

---

### PAGE 10 - BACK COVER
**Layout:** Back cover
**Visual Note:** Bold corporate branding in slate, amber, and ivory. Clean typographic layout. Subtle spotlight or stage motif.
